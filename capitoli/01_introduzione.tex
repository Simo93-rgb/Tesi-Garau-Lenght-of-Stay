...
Il primo obiettivo è lo sviluppo di un sistema di classificazione binaria basato sull'architettura Transformer per prevedere in anticipo se la degenza di un paziente supererà una soglia critica, fissata a 20 giorni. Il modello fa leva sull'approccio dello \textit{Storytelling}, trasformando i log in formato XES in narrazioni testuali ed impiegando \texttt{bert-base-uncased} per catturare le connessioni logiche tra i vari eventi clinici.
