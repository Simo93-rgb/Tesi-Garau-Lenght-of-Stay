...
\begin{frame}{La Sfida: Aggregazione dei Sub-Token}
  \begin{alertblock}{WordPiece frammenta le parole in sub-token privi di significato, serve ricostruirle.}
  \end{alertblock}
    ...
    \begin{column}{0.45\textwidth}
      ...
      \begin{tikzpicture}[
        ...
        \node[finalbox, below=1.2cm of vis]
          (fvis) {\textbf{visit}};
        \node[font=\tiny\bfseries\color{successgreen!70!black},
          below=0.1cm of fvis] (lvis) {score: $+18.92$};
        ...
        \draw[arr] (fcardio.south) -- (fcombined.north west);
        \draw[arr] (fvis.south) -- (fcombined.north east);
      \end{tikzpicture}}
