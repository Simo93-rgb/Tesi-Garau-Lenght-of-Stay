...
% Rimuove icone di navigazione
\setbeamertemplate{navigation symbols}{}

% Numerazione slide: X / N
\setbeamertemplate{footline}{%
  \leavevmode%
  \hbox{%
    \begin{beamercolorbox}[wd=0.70\paperwidth, ht=2.5ex, dp=1ex, leftskip=2mm]{normal text}%
      \usebeamerfont{footline}\insertshorttitle
    \end{beamercolorbox}%
    \begin{beamercolorbox}[wd=0.30\paperwidth, ht=2.5ex, dp=1ex, rightskip=2mm, right]{normal text}%
